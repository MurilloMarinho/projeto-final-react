...
const SignIn = () => {
    ...
    const efetuarCadastro = (evento) => {
        ...
        if (senha == senhaConfirm) {
            ...
            return console.log('As senhas sao diferentes')
        }
    }
        ...
        <div>
            ...
            <form onSubmit={efetuarCadastro} className='form-registro'>
                ...
                <div>
                    ...
                    <input value={senhaConfirm} onChange={(e) => setSenhaConfirm(e.target.value)} type="password" required />
                </div>
                <div>
                    <label>CPF</label>
                ...
                <div>
                    ...
                    <input value={dataNascimento} onChange={(e) => setDataNascimento(e.target.value)} type="text" required />
                </div>
